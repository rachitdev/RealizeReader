...
public class MobileEmulationUserAgentConfiguration {
	...
	@SuppressWarnings("serial")
	private final HashMap<String, String> samsung_galaxy_tab_4_4_2_landscape = new HashMap<String, String>() {
		{
	...
	@SuppressWarnings("serial")
	private final HashMap<String, String> samsung_galaxy_tab_4_4_2_portrait = new HashMap<String, String>() {
		{
			put("userAgent", "Mozilla/5.0 (Linux; Android 4.4.2; SM-T230NU Build/KOT49H) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/39.0.2171.93 Safari/537.36");
			put("width", "600");
			put("height", "961");
	...
	@SuppressWarnings("serial")
    private final HashMap<String, String> apple_ipad4_ios10_landscape = new HashMap<String, String>() {
        {
    ...
    @SuppressWarnings("serial")
    private final HashMap<String, String> apple_ipad4_ios10_portrait = new HashMap<String, String>() {
        {
            put("userAgent", "Mozilla/5.0 (iPad; CPU OS 10_0_2 like Mac OS X) AppleWebKit/602.1.50 (KHTML, like Gecko) Version/10.0 Mobile/14A456 Safari/602.1");
            put("width", "768");
            put("height", "1024");
    ...
    @SuppressWarnings("serial")
    private final HashMap<String, String> chrome_book = new HashMap<String, String>() {
        {
